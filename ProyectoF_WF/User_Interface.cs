...
namespace ProyectoF_WF
{
    public partial class User_Interface : Form
    {
        ...
        {
            openFileDialog.Filter = "Archivos de imagen|*.jpg;*.jpeg;*.png;*.bmp;*.gif|Archivos de video|*.mp4;*.mov;*.avi;*.wmv;*.mkv"; // Filtrar por extensiones de imagen y video
        ...
        private void User_Interface_KeyDown(object sender, KeyEventArgs e)
        {
            if (pbCargarImagenes.Focus())
            {
                ...
                {
                    case Keys.Space:
                        this.WindowState = FormWindowState.Normal; // Restaura el tamaño normal del formulario
                        this.FormBorderStyle = FormBorderStyle.Sizable; // Restaura el borde redimensionable del formulario
                        panel1.Visible = true; // Vuelve a hacer visible el menú
